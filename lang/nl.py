...
SENTENCE_1_ALL = "(NOUN MARKER) '''{{{{item name|{item_name}}}}}''' is {noun_marker}{workshop_link}{promotional} {item_type} voor {class_list}."
...
SENTENCE_1_CLASSES_ONE = "(Article) [[{class_name}/nl|{loc_class_name}]]"
SENTENCE_1_CLASSES_MORE = "en (Article) [[{class_name}/nl|{loc_class_name}]]."
...
SENTENCE_PROMOTIONAL_DATE = " voor {date}"
