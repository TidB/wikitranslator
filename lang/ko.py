...
SENTENCE_1_ALL = "'''{{{{item name|{item_name}}}}}'''은/는 {class_list}이/가 착용할 수 있는 {noun_marker}{workshop_link}{promotional} {item_type}입니다."
SENTENCE_1_COMMUNITY_COSMETIC = "[[Steam Workshop/ko|커뮤니티 제작]]"
...
SENTENCE_1_CLASSES_COMMA = " 와/과 "

SENTENCE_COMMUNITY = "{{{{item name|{item_name}}}}}은/는 [[Steam Workshop/ko|Steam 창작마당]]에 {custom_name} {workshop_link}."
SENTENCE_COMMUNITY_LINK = "[{link} 기여되었습니다]"
SENTENCE_COMMUNITY_NAME = "\"{name}\"(이)라는 이름으로"

SENTENCE_PROMOTIONAL = "{{{{item name|{item_name}}}}}은/는 [[{game_name}/ko|{game_name}]]을/를{steam}{date} 구매한 플레이어들에게 [[Genuine/ko|진품]] 품질로 지급되었습니다."
SENTENCE_PROMOTIONAL_STEAM = " [[Steam/ko|Steam]]에서"
SENTENCE_PROMOTIONAL_DATE = " {date} 이전까지"

SENTENCE_SET = "{{{{Update link|{update}}}}} 때 게임에 추가되었습니다."
SENTENCE_SET_INCLUDES = "이 세트는 아래의 아이템으로 구성되어 있습니다."

SENTENCE_THUMBNAIL = "|{{item name|{item_name}}}의 Steam 창작마당 섬네일"

SENTENCE_1_SUB_PRIMARY = "[[Weapon/ko#{class_name}primary|주무기]]"
SENTENCE_1_SUB_SECONDARY = "[[Weapon/ko#{class_name}secondary|보조무기]]"
...
ITEM_LEVELS = {
    ...
    'Botkiller': "봇 파괴용",
    'Cape': "망토",
    'Championship Belt': "챔피언 벨트",
    'Cigar': "담배",
    'Coat': "외투",
    'Coffin': "관짝",
    'Community Medal': "커뮤니티 메달",
    'Conscience': "양심",
    'Cooler': "냉각기",
    'Cosmetic Armor': "장식용 갑옷",
    'Cosmetic Augmentation': "장식용 강화장치",
    'Cosmetic Axe': "장식용 도끼",
    'Cosmetic Knife': "장식용 칼",
    'Costume Piece': "역할 의상",
    'Decorative Bombs': "장식용 폭탄",
    'Duck': "오리",
    'Electronic Device': "전자 장비",
    'Eye Stalks': "눈자루",
    'Facial Hair': "수염",
    'Flair!': "아주 좋소!",
    'Flip-Flops': "샌들",
    ...
    'Futuristic Sound Device': "초현대적 음향장치",
    'Ghost': "유령",
    'Glasses': "안경",
    'Glove': "장갑",
    'Gloves': "장갑",
    ...
    'Medal': "훈장",
    'Medallion': "메달",
    'Mystical Lamp': "신비한 등잔",
    'Necklace': "목걸이",
    'Photograph': "사진",
    'Pin': "장식핀",
    'Pipe': "파이프",
    'Pocket Buddy': "호주머니 친구",
    'Pocket Square': "장식용 손수건",
    'Poncho': "판초",
    'Puffy Shirt': "펑퍼짐한 상의",
    ...
    'Ring': "반지",
    'Robot': "로봇",
    'Safety Apparatus': "안전 장비",
    'Satchel': "주머니",
    'Scarf': "스카프",
    'Science Project': "과학시간 과제물",
    'Shield': "방패",
    'Shirt': "셔츠",
    'Shoes': "신발",
    'Skateboard': "스케이트 보드",
    ...
    'Snow Globe': "스노우 글로브",
    'Spikes': "가시",
    'Spirit Animal': "정신적 야수",
    'Spooky Companion': "으스스한 동료",
    'Spurs': "박차",
    'Squirrel': "다람쥐",
    'Stethoscope': "청진기",
    'Stocking': "양말",
    ...
    'Tattoos': "문신",
    'Tentacles': "촉수",
    'Tournament Medal': "토너먼트 훈장",
    'Towel': "수건",
    'Treasure': "보물",
    'Tuxedo': "턱시도",
    'Undead Pet': "불멸의 애완동물",
    'Uniform': "제복",
    "Veteran's Beret": "참전용사의 베레모",
    'Wings': "날개",
}
