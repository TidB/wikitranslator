...
SENTENCE_1_ALL = "(ARTIGO) '''{{{{item name|{0}}}}}''' (''{0}'') é {1} {4} {3}{2} para {5}."
...
SENTENCE_1_CLASSES_ONE = "o [[{0}]]"
SENTENCE_1_CLASSES_MORE = " e para o [[{0}]]."
...
SENTENCE_1_SUB_MELEE = "[[Weapon/pt-br#{0}melee|arma corpo a corpo]]"
